...
const [filteredItems, setFilteredItems] = useState(postTshirt);
  
let filters = ["AnimeTshirt", "CustomizedTShirts",];
...
const filterItems = () => {
  if (selectedFilters.length > 0) {
    let tempItems = selectedFilters.map((selectedCategory) => {
      let temp = postTshirt.filter((item) => item.subcategory === selectedCategory);
      return temp;
    });
